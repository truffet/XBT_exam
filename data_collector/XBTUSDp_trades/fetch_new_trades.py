...
def fetch_new_trades(endpoint: str, symbol: str, last_update_time: str, end_time: str, count: int) -> List[dict]:
    trades = []
    params = {"symbol": symbol, "startTime": last_update_time, "endTime": end_time, "count": count}
    while True:
